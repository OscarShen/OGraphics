...
// render a 1x1 quad with mapping
void renderQuad();
...
#pragma region "object_initialization"
	Shader shader("Texture/NormalMapping/normal_mapping.vs", "Texture/NormalMapping/normal_mapping.frag");

	// Load textures
	GLuint diffuseMap = loadTexture("resource/texture/brickwall.jpg");
	GLuint normalMap = loadTexture("resource/texture/brickwall_normal.jpg");
