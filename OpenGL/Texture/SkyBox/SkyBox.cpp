...
int main() {
	...
	Shader shader("Texture/SkyBox/vertex.vs", "Texture/SkyBox/fragment.frag");
	Shader skyboxShader("Texture/SkyBox/skybox.vs", "Texture/SkyBox/skybox.frag");
...
#pragma endregion
	...
	faces.push_back("resource/texture/skybox/right.jpg");
	faces.push_back("resource/texture/skybox/left.jpg");
	faces.push_back("resource/texture/skybox/top.jpg");
	faces.push_back("resource/texture/skybox/bottom.jpg");
	faces.push_back("resource/texture/skybox/back.jpg");
	faces.push_back("resource/texture/skybox/front.jpg");
...
GLuint loadCubemap(std::vector<const GLchar*> faces)
{
	...
	{
		image = SOIL_load_image(faces[i], &width, &height, &channel, SOIL_LOAD_RGB);
