...
int main() {
	...
	Shader shader("Coordination/resource/matrix.vs", "Coordination/resource/matrix.frag");
	// Cube
	GLfloat vertices[] = {
	...
	int width, height;
	unsigned char* image = SOIL_load_image("Coordination/resource/container.jpg", &width, &height, 0, SOIL_LOAD_RGB);
